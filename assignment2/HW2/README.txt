...
The code is fork from https://github.com/cmaron/CS-7641-assignments. 
the data.csv file is created by the file CS-7641-assignments\assignment2\HW2\data_preparation.py

All of following code should run from /CS-7641-assignments/assignment2
